...
call "%msBuildDir%\msbuild.exe"  "%loc%DLA.vcxproj" /p:Configuration=Release /l:FileLogger,Microsoft.Build.Engine;logfile=DLA.log >temp\batch_compile_release_output_%timestamp%.log 2>&1
